const fakeData = [
  ...
  {
    name: "POWERED para iPhone",
    description:
      "La carga inalámbrica con iPhone debería ser una experiencia sublime. No te conformes con nada inferior. Elige POWERED para iPhone, el único soporte de carga inalámbrica a la altura de la magia del iPhone.",
    rating: [4],
    Reviews: [],
    image: [
